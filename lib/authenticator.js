 ...
 * 注册一个函数用来将user对象序列化到session中，这个session可能放在内存中或数据库中
 * Examples:
 *
 ...
 *     });
 *
 * @api public  此处的done在具体的验证策略中进行了定义,参考session.js中的authenticate方法
 */
Authenticator.prototype.serializeUser = function(fn, req, done) {
  //如果是函数，则保存到_serializers数组中
 ...
 * 注册一个函数将user从session中反序列化到req.user中
 * Examples:
 *
